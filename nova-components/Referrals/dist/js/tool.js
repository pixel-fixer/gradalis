...
var update = __webpack_require__(11)("290c3e45", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DataTable_vue__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            regCountMonth: 0,
            regCountWeek: 0,
            columns: [{ data: 'created', title: 'Дата', className: 'text-left' }, { data: 'click', title: 'Всего кликов', className: 'text-left' }, { data: 'uniq', title: 'Уник. кликов', className: 'text-left' }, { data: 'regs', title: 'Регистрации', className: 'text-left' }]
        };
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getSellersAndBuyers: function getSellersAndBuyers() {
            var vm = this;
            axios.get('/nova-vendor/referrals/get-sellers-buyers').then(function (responce) {
                var data = responce.data;
                console.log(data);
        ...
        getCampaigns: function getCampaigns() {
            var vm = this;
            axios.get('/nova-vendor/referrals/get-campaigns').then(function (responce) {
                vm.campaigns = responce.data;
            });
        },
        getTypes: function getTypes() {
            var vm = this;
            axios.get('/nova-vendor/referrals/get-types').then(function (responce) {
                vm.types = responce.data;
            });
        },
        statusSellerChange: function statusSellerChange() {
            this.dataTable.ajax.reload(null, false);
        },
        statusCampaignChange: function statusCampaignChange() {
            this.dataTable.ajax.reload(null, false);
        },
        statusTypeChange: function statusTypeChange() {
            this.dataTable.ajax.reload(null, false);
        },
        title: function title(column) {
        ...
        parameters: function parameters() {
            ...
            return window.$.extend({
                ...
                createdRow: function createdRow() {
                    ...
                    vm.$emit.apply(vm, ['created-row'].concat(_toConsumableArray(args)));
                },
                drawCallback: function drawCallback() {
                    ...
                    vm.$emit.apply(vm, ['draw'].concat(_toConsumableArray(args)));
                },
                footerCallback: function footerCallback() {
                    ...
                    vm.$emit.apply(vm, ['footer'].concat(_toConsumableArray(args)));
                },
                formatNumber: function formatNumber() {
                    ...
                    vm.$emit.apply(vm, ['format'].concat(_toConsumableArray(args)));
                },
                headerCallback: function headerCallback() {
                    ...
                    vm.$emit.apply(vm, ['header'].concat(_toConsumableArray(args)));
                },
                infoCallback: function infoCallback() {
                    ...
                    vm.$emit.apply(vm, ['info'].concat(_toConsumableArray(args)));
                },
                initComplete: function initComplete() {
                    ...
                    vm.$emit.apply(vm, ['init'].concat(_toConsumableArray(args)));
                },
                preDrawCallback: function preDrawCallback() {
                    ...
                    vm.$emit.apply(vm, ['pre-draw'].concat(_toConsumableArray(args)));
                },
                rowCallback: function rowCallback() {
                    ...
                    vm.$emit.apply(vm, ['draw-row'].concat(_toConsumableArray(args)));
                },
                stateLoadCallback: function stateLoadCallback() {
                    for (var _len10 = arguments.length, args = Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {
                        args[_key10] = arguments[_key10];
                    }

                    vm.$emit.apply(vm, ['state-load'].concat(_toConsumableArray(args)));
                },
                stateLoaded: function stateLoaded() {
                    ...
                    vm.$emit.apply(vm, ['state-loaded'].concat(_toConsumableArray(args)));
                },
                stateLoadParams: function stateLoadParams() {
                    for (var _len12 = arguments.length, args = Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
                        args[_key12] = arguments[_key12];
                    }

                    vm.$emit.apply(vm, ['state-load-params'].concat(_toConsumableArray(args)));
                },
                stateSaveCallback: function stateSaveCallback() {
                    for (var _len13 = arguments.length, args = Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
                        args[_key13] = arguments[_key13];
                    }

                    vm.$emit.apply(vm, ['state-save'].concat(_toConsumableArray(args)));
                },
                stateSaveParams: function stateSaveParams() {
                    for (var _len14 = arguments.length, args = Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {
                        args[_key14] = arguments[_key14];
                    }

                    vm.$emit.apply(vm, ['state-save-params'].concat(_toConsumableArray(args)));
                }
            }, this.options);
        }
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "w-full" }, [
      ...
      _c("div", { staticClass: "py-6 px-8 w-1/6" }, [
        _c(
            ...
            on: {
              change: [
                function($event) {
                  ...
                  _vm.statusType = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                },
                function($event) {
                  _vm.statusTypeChange()
                }
              ]
            }
          },
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.types, function(type, id) {
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.statusSeller,
                expression: "statusSeller"
              }
            ],
            staticClass: "form-control form-select",
            attrs: { id: "status" },
            on: {
              change: [
                function($event) {
                  ...
                  _vm.statusSeller = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                },
                function($event) {
                  _vm.statusSellerChange()
                }
              ]
            }
          },
        ...
        _c(
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.statusCampaign,
                expression: "statusCampaign"
              }
            ],
            staticClass: "form-control form-select",
            attrs: { id: "campaign" },
            on: {
              change: [
                function($event) {
                  ...
                  _vm.statusCampaign = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                },
                function($event) {
                  _vm.statusCampaignChange()
                }
              ]
            }
          },
          [
            ...
            _vm._l(_vm.campaigns, function(campaign) {
              return _c("option", { domProps: { value: campaign.id } }, [
                _vm._v(_vm._s(campaign.name.ru) + " " + _vm._s(campaign.id))
              ])
            })
          ],
          2
    ...
    _vm._v(" "),
    _c("table", { ref: "referrals-table", staticClass: "table w-full" }, [
      _c("thead", [
        _c(
          "tr",
