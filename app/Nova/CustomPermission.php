...
class CustomPermission extends Resource
{
    /**
    ...
    public function fields(Request $request)
    {
        ...
        return [
            ...
            BelongsToMany::make(CustomRole::label(), 'roles', CustomRole::class)
                ->searchable()
                ->singularLabel(CustomRole::singularLabel()),
            MorphToMany::make(__('nova-permission-tool::permissions.users'),
                'users', $userResource)
                ->searchable()
                ->singularLabel(__('nova-permission-tool::permissions.user')),
        ];
    }
