<div class="card card-service-2">
                       ...
                       <span class="location is-size-875 is-flex align-items-center">
                               <div>
                                    <div class="icon is-flex">
                                        <img src="{{ asset('/svg/icons/ic_location.svg') }}" alt="">
                                    </div>
                                    <div class="icon is-flex">
                                        <img src="http://marketplacenew.local/svg/icons/ic_flag_russian.svg" alt="">
                                    </div>
                               </div>
    ...
    <div class="card-service-2__footer">
        <a class="button is-link is-outlined is-size-875 has-text-weight-bold h-3">Заказать</a>
        <a class="button is-clear is-clear_close is-size-875 h-3" href="#"><span class="has-text-decoration-underline">Подробнее</span></a>
    </div>
</div>
