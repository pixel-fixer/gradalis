            ...
            <div class="column is-8">
                                ...
                                <div class="card-object-pa__body p-1-5">
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-8">
                                                ...
                                                <div class="card-object-pa__progress__bar">
                                                    <div class="columns is-gapless">
                                                        <div class="column is-6">
                                                            <progress class="progress is-warning is-small" value="100"
                                                                      max="100">
                                                                60%
                                                            </progress>
                                                        </div>
                                                        <div class="column is-3">
                                                            <progress class="progress is-success is-small" value="0"
                                                                      max="100">
                                                                60%
                                                            </progress>
                                                        </div>
                                            ...
                                            <div>
                                                <button
                                                    class="button is-outlined h-3 has-text-weight-bold is-size-875"
                                                    disabled>
                                                    Нет новых запросов
                                                </button>
                                            </div>
                ...
                <section class="section pt-1 mt-1 px-0">
                    ...
                    <table class="table is-fullwidth is-size-875">
                        ...
                        <tr>
                            <td class="has-text-weight-bold has-vertical-align-middle">Мини-отель в собственность с
                                видом на Невский проспект
                            </td>
                ...
                <section class="section pt-1 px-0">
                    <h1 class="section-title mb-1-75">Ваши франшизы</h1>
                    <div class="buttons has-addons">
                        <button class="button is-outlined is-info is-size-875 has-text-weight-bold h-3 is-active">
                            Активные франшизы
                        </button>
                    ...
                    <div class="columns is-multiline">
                        <div class="column is-12">
                            ...
                            <article class="box card-object-pa is-paddingless">
                                ...
                                <div class="card-object-pa__statistics-full p-1-5">
                                    <div class="columns is-multiline">
                                        <div class="column is-2">
                                            <div class="is-size-875 has-text-basic">
                                                ...
                                                <div class="is-flex has-align-items-center">
                                                    ...
                                                    <span class="has-text-weight-bold">1 290</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-2">
                                            <div class="is-size-875 has-text-basic">
                                                ...
                                                <div class="is-flex has-align-items-center">
                                                    ...
                                                    <span class="has-text-weight-bold">90</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-2">
                                            <div class="is-size-875 has-text-basic">
                                                ...
                                                <div class="is-flex has-align-items-center">
                                                    ...
                                                    <span class="has-text-weight-bold">290</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-2">
                                            <div class="is-size-875 has-text-basic">
                                                <div>Отзывы <span
                                                        class="tag is-light is-rounded has-text-weight-bold">3</span>
                                                </div>
                                                <div class="is-flex has-align-items-center">
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-narrow">
                                            <a href="#" class="is-flex has-align-items-center link-with-icon">
                                                <span class="icon icon-1">
                                                     <img src="{{ asset('/svg/icons/ic_details.svg') }}" class="svg"
                                                          alt="">
                                                </span>
                                                <span
                                                    class="is-size-875 has-text-decoration-underline">Посмотреть</span>
                                            </a>
                                        </div>
                                        <div class="column is-narrow">
                                            ...
                                            <div class="dropdown is-hoverable">
                                                <div class="dropdown-trigger">
                                                    <a class="is-flex has-align-items-center link-with-icon"
                                                       aria-haspopup="true"
                                                       aria-controls="dropdown-menu4">

                                                            <span class="icon icon-1 has-text-basic">
                                                                 +
                                                            </span>
                                                        <span
                                                            class="is-size-875 has-text-decoration-underline">Добавить</span>
                                                    </a>
                                                </div>
                                                <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                                    <div class="dropdown-content is-paddingless">
                                                        <a class="dropdown-item"
                                                           @click="franchise.showModalAddObject = true">Новый объект</a>
                                                        <hr class="dropdown-divider is-marginless">
                                                        <a class="dropdown-item"
                                                           @click="franchise.showModalAddReview = true">Отзыв</a>
                                                        <hr class="dropdown-divider is-marginless">
                                                        <a class="dropdown-item" @click="franchise.showModalAddNews = true">Новость</a>
                                                    </div>
                                                </div>
                                                <!-- Modal -->
                                                ...
                                                <!-- Modal -->
                                                <modal-add-object-franchise :show="franchise.showModalAddObject"
                                                                            @close="franchise.showModalAddObject = false"
                                                ></modal-add-object-franchise>
                                                <!-- Modal -->
                                                <modal-add-news-franchise :show="franchise.showModalAddNews"
                                                                          @close="franchise.showModalAddNews = false"
                                                ></modal-add-news-franchise>
                                            </div>
                                        </div>
                                    </div>
                                </div>
