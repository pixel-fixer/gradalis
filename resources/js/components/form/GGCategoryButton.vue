<template>
    <div class="column is-3">
        <div class="field">
            ...
            <div class="control">
                <div :class="(selected === null)?'inputbox-val':''" class="input h-3" @click="modalCategoryShow = !modalCategoryShow">{{selectedName}}
                    <!--Modal-->
                    <portal to="modals">
                            ...
                            <div class="modal-card modal-card_big">
                                ...
                                <section class="modal-card-body is-paddingless">
                                    <ul class="category-list">
                                        <li :class="(category.id === selected)?'is-active':''" @click="setCategory(category.id,category.translation.ru)" v-for="category in categories"
                                    ...
                                    <div v-if="subShow" class="subcategory-wrap">
                                        ...
                                        <ul class="subcategory-list">
                                            <li :class="(category.id === selected)?'is-active':''" @click="setCategory(category.id,category.translation.ru)" v-for="category in subCategories"
                                ...
                                <footer class="modal-card-foot">
                                    <button @click="save" class="button is-info save is-size-875 has-text-weight-bold">Сохранить
                                        категорию
                                    </button>
                                    <button @click="reset" class="button clear is-size-875"><img src="/svg/icons/ic_close.svg" alt=""
                                                                                  class="svg"><span>Сбросить</span>
                                    </button>
                                </footer>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        props: {
            value: null,
            label: {default: 'Категория бизнеса'},
        },
        data() {
            return {
