        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                <div class="columns is-multiline list-wrap"
                    ...
                    <g-g-select-input @input="inputChange" :size="'is-3-desktop is-6-tablet'" v-model="item.direction"
                    ...
                    <div class="column is-6-desktop is-12-tablet">
                        <div class="columns is-multiline">
                            <div class="column">
                                <div class="columns is-multiline">
                                    <g-g-input @input="inputChange" :size="'is-6'"
                                               v-model="item.phone"
                            ...
                            <div class="column is-narrow">
                                <div class="buttons has-justify-content-center">
                                    <button class="button is-warning is-outlined button-remove"
                                        ...
                                        <span class="is-size-875 is-hidden-tablet">{{trans('business.create.contractors.remove')}}</span>
                                    </button>
